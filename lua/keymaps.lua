...
vks('n',leaderKey..'J',':resize -5<CR>',opts)
vks('n',leaderKey..'K',':resize +5<CR>',opts)
vks('n',leaderKey..'L',':vertical resize -5<CR>',opts)
vks('n',leaderKey..'H',':vertical resize +5<CR>',opts)
